    ...
    public AppStack()
    {
        ...
        WebApp webApp = new($"app-service-app-{stackName}", new()
        {
            ...
            SiteConfig = new SiteConfigArgs
            {
                ...
                AppCommandLine = "dotnet Issue7682.Server.dll",
                AppSettings = new()
                {
        ...
        Secret sqlDatabaseConnectionStringSecret = new(sqlDatabaseConnectionStringSecretName, new()
        {
            ...
            Properties = new SecretPropertiesArgs
            {
                Value = Output.Tuple(sqlServer.Name, sqlDatabase.Name, sqlDatabaseDbAdminPassword).Apply(t =>
                {
                    ...
                    return $"Data Source=tcp:{_sqlServer}.database.windows.net;Initial Catalog={_sqlDatabase};User ID={sqlDatabaseDbAdminId};Password={_sqlDatabasePassword};Application Name=Issue7682;Encrypt=True;";
                })
            }
        });
    }
