...
using System.Web;
using Issue7682.Client.Core.Services;
...
public static partial class Program
{
    ...
    public static void ConfiureMiddlewares(this WebApplication app)
    {
        ...
        var blazorApp = app.MapRazorComponents<Issue7682.Server.Components.App>()
            .AddInteractiveServerRenderMode()
            .AddInteractiveWebAssemblyRenderMode()
            .AddAdditionalAssemblies(AssemblyLoadContext.Default.Assemblies.Where(asm => asm.GetName().Name?.Contains("Issue7682") is true).Except([Assembly.GetExecutingAssembly()]).ToArray());
