...
using Issue7682.Server.Services;
using Issue7682.Client.Web;
...
public static partial class Program
{
    ...
    private static void AddSwaggerGen(WebApplicationBuilder builder)
    {
        ...
        {
            options.IncludeXmlComments(Path.Combine(AppContext.BaseDirectory, "Issue7682.Server.xml"));
            options.IncludeXmlComments(Path.Combine(AppContext.BaseDirectory, "Issue7682.Shared.xml"));
